...
SPIDesc SPIDeviceManager::_device[] = {
    SPIDesc("mpu9250", 0, 0, SPI_MODE_0, 8, SPI_CS_KERNEL, 1*KHZ, 9*MHZ),
    SPIDesc("ms5611",  0, 2, SPI_MODE_0, 8, SPI_CS_KERNEL, 1*KHZ, 9*MHZ),
    SPIDesc("mpu6000", 0, 1, SPI_MODE_0, 8, SPI_CS_KERNEL, 1*KHZ, 9*MHZ),
